...
def get_segmentation_transform(mode='train'):
    ...
    # Transforms d'augmentation (uniquement en train)
    if mode == 'train':
        ...
        all_transforms = base_transforms + augmentation_transforms
    else:
...
def get_classification_transform(mode='train'):
    ...
    if mode == 'train':
        ...
        all_transforms = base_transforms + augmentation_transforms + [T.ToTensord(keys=["image", "label"])]
    else:
        all_transforms = base_transforms + [T.ToTensord(keys=["image", "label"])]
...
val_dataloaders = {'seg': seg_val_loader,
                   'cls': cls_val_loader
                   }
